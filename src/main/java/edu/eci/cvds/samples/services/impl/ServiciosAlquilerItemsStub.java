...
public class ServiciosAlquilerItemsStub implements ServiciosAlquiler {
   ...
   private void poblar() {
       ...
       Item i1=new Item(ti1, 1, "Los 4 Fantasticos", "Los 4 Fant�sticos  es una pel�cula de superh�roes  basada en la serie de c�mic hom�nima de Marvel.", java.sql.Date.valueOf("2005-06-08"), 2000, "DVD", "Ciencia Ficcion");
       ...
       Item i3=new Item(ti3, 3, "Thriller", "Thriller es una canci�n interpretada por el cantante estadounidense Michael Jackson, compuesta por Rod Temperton y producida por Quincy Jones.", java.sql.Date.valueOf("1984-01-11"), 2000, "DVD", "Pop");
       Item i4=new Item(ti1, 4, "Los 4 Fantasticos", "Los 4 Fant�sticos  es una pel�cula de superh�roes  basada en la serie de c�mic hom�nima de Marvel.", java.sql.Date.valueOf("2005-06-08"), 2000, "DVD", "Ciencia Ficcion");
       ...
       Item i6=new Item(ti3, 6, "Thriller", "Thriller es una canci�n interpretada por el cantante estadounidense Michael Jackson, compuesta por Rod Temperton y producida por Quincy Jones.", java.sql.Date.valueOf("1984-01-11"), 2000, "DVD", "Pop");
       //items.put(1, i1);
       //items.put(2, i2);
       //items.put(3, i3);
